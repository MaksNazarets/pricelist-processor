...
const fillingMethods: { [key: string]: string } = {
                                    ...
                                    {(provided) => (
                                        ...
                                        >
                                            ...
                                            <div className="right-part">
                                                {newColumns.map(col => col.name).includes(colName)
                                                    && <span
                                                        className="item-parameters-btn"
                                                        onClick={() => showItemParameters(colName)}>⋯</span>
                                                }
                                                <span className="col-letter">{getColumnLetters(index + 1)}</span>
                                                <span className="remove-btn" onClick={() => removeItem(colName)}>&#x2715;</span>
                                            </div>
                                        </div>
                                    )}
                                </Draggable>
